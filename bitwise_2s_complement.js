...
Number.prototype.twos = function(n) {
  ...
  if(this >=0){
    ...
    var smallest = Math.pow(2, n-1);
    var difference = smallest - Math.abs(this);
    var bits = difference.toString(2);
  }

  //Add 0s if needed so length of string is n
  var buffers = n -1 - bits.length;
